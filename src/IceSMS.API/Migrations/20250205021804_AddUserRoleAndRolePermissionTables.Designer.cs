...
namespace IceSMS.API.Migrations
{
    ...
    [Migration("20250205021804_AddUserRoleAndRolePermissionTables")]
    partial class AddUserRoleAndRolePermissionTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IceSMS.API.Models.Domain.RolePermission", b =>
                {
            ...
            modelBuilder.Entity("IceSMS.API.Models.Domain.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("IceSMS.API.Models.Domain.RolePermission", b =>
                {
                    b.HasOne("IceSMS.API.Models.Domain.Permission", "Permission")
                        .WithMany()
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IceSMS.API.Models.Domain.Role", "Role")
                        .WithMany()
